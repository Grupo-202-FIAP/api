...
import com.postech.fastfood.infrastructure.persistence.repository.order.IOrderItemRepository;
import com.postech.fastfood.infrastructure.persistence.repository.product.IProductRepository;
...
public class OrderRepositoryAdapter implements OrderRepositoryPort {
    ...
    public OrderRepositoryAdapter(IOrderEntityRepository orderEntityRepository, ICustomerEntityRepository customerEntityRepository,
                                  IProductRepository productRepository, IOrderItemRepository orderItemRepository, LoggerPort logger) {
