...
import com.postech.fastfood.infrastructure.repository.order.IOrderEntityRepository;
...
public class PaymentRepositoryAdapter implements PaymentRepository {
    ...
    private OrderEntity getOrderById(UUID orderId) {
        return orderEntityRepository.findById(orderId)
                .orElseThrow(() -> new FastFoodException("Order not found for ID: " + orderId, "Order Not Found", HttpStatus.NOT_FOUND));
    }
